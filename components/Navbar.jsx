								...
								{providers &&
									Object.values(providers).map(
										(provider, index) => (
											<button
												key={index}
												// Clicking on the login button will now redirect us a page where you can choose
												// a Google account to login to the PropertyPulse App we created at https://console.cloud.google.com
												onClick={() =>
													signIn(provider.id)
												}
