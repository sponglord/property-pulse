...
const PropertyAddForm = () => {
	/**
	 * The use of this "mounted" useState & useEffect combo is to avoid an error:
	 * "Did not expect server HTML to contain a <div> in <div>"
	 *
	 * (Although we weren't actually seeing this error)
	 */
	...
	// Initially use dummy values for testing the form
	...
	return (
		mounted && (
			<form
				// Use a restful route to make POST request to api/properties
				// ('cos we have an image field we need an encType to allow us to upload images)
