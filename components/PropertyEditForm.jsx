...
import { useParams, useRouter } from 'next/navigation'; // so we can get id from the URL
...
const PropertyEditForm = () => {
	...
	useEffect(() => {
		...
		const fetchPropertyData = async () => {
			try {
				...
				console.error('Failed to fetch property data:: error=', error);
			} finally {
				setLoading(false);
			}
		};
	...
	return (
		...
		!loading && (
			<form
				onSubmit={handleSubmit} // We can't do a PUT by setting a method attribut on the form, so we use a handler instead
			>
